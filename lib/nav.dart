...
import 'package:thix_id/presentation/thix_market/pages/search_page.dart';
...
// ---- CORRECTION : imports des pages produits, détail et panier (dans details/) ----
  ...
  static GoRouter create(AuthController auth, {Listenable? extraRefreshListenable}) {
    ...
    return GoRouter(
      ...
      routes: [
        ...
        // ---- THIX Market (remplacé par les routes complètes) ----
        GoRoute(
