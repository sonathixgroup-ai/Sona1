...
// FIX: Utilisation du chemin absolu package: pour garantir la détection du modèle
...
class _EventCreateEditPageState extends State<EventCreateEditPage> {
  ...
  Future<void> _pickImage(bool isBanner) async {
    ...
    if (x != null) {
      setState(() => isBanner ? _pickedBanner = File(x.path) : _pickedImage = File(x.path));
    }
  }
          ...
          children: [
            ...
            Row(children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: ['concert', 'conférence', 'sport', 'festival', 'théâtre', 'autre']
            ...
            Row(children: [
              ...
              Row(children: [
                ...
                const Text('Featured / Star', style: TextStyle(fontSize: 12))
              ]),
            ]),
            const SizedBox(height: 12),
            ListTile(
              title: Text('Début: ${_startDate.toString().substring(0, 16)}'),
  ...
  Widget _field(TextEditingController c, String label,
      {int maxLines = 1, bool enabled = true, TextInputType? keyboard, String? Function(String?)? validator}) {
  ...
  InputDecoration _deco(String label) => InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: Color(0xFFE7EEFC)),
        ),
