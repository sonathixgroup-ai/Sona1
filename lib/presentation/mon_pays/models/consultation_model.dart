...
/// Modèle représentant une consultation publique
@JsonSerializable()
class Consultation extends Equatable {
  final String id;
  final String title;
  final String description;
  final String startDate; // format "2025-06-01"
  final String endDate; // format "2025-07-01"
  final bool isActive;
  final String? link; // Lien de participation
