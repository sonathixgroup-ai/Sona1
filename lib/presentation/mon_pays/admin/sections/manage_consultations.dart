...
class ManageConsultations extends ConsumerWidget {
  const ManageConsultations({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DataTableWidget<Consultation>(
      ...
      columns: const [
        ...
        DataColumnConfig(label: 'Début'),
        DataColumnConfig(label: 'Fin'),
      ...
      onEdit: (consultation) => _showEditDialog(context, consultation, controller),
      onDelete: (consultation) => _confirmDelete(context, consultation.id, controller),
  ...
  void _showEditDialog(BuildContext context, Consultation consultation, AdminController controller) {
    FormDialog.show(
      context: context,
