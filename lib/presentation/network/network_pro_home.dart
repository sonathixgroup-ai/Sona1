...
class _NetworkProHomeState extends ConsumerState<NetworkProHome> with AutomaticKeepAliveClientMixin {
    ...
    return SliverAppBar(
      ...
      actions: [
        ...
        Padding(
          ...
          child: GestureDetector(onTap: () => context.push('/profile'), child: const CircleAvatar(radius: 14, backgroundColor: ThixColors.softBlue, child: Icon(Icons.person, size: 15))),
        ),
      ],
    );
  }
        ...
        itemBuilder: (c, i) {
          if (i == 0) {
            return _MyStoryItem(
              ...
              onView: myStories.isNotEmpty ? () => Navigator.push(context, MaterialPageRoute(builder: (_) => StoryViewer(stories: myStories, initialIndex: 0))) : _openCreateStory,
            ...
            return Padding(
              ...
              child: InkWell(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(color: sel ? ThixColors.primary : ThixColors.softBlue, borderRadius: BorderRadius.circular(30)),
                  child: Row(children: [
      ...
      child: Row(children: [
        ...
        Expanded(
          child: GestureDetector(
            onTap: () => showDialog(context: context, builder: (_) => const CreatePostDialog()).then((v) { if (v == true) ref.read(feedProvider.notifier).loadFeed(force: true); }),
  ...
  Widget _buildSuggestions() {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(18), border: Border.all(color: ThixColors.border)),
    ...
    return GestureDetector(
      ...
      child: Column(children: [
        Stack(clipBehavior: Clip.none, children: [
          hasStory
              ? Container(padding: const EdgeInsets.all(2.5), decoration: const BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: [ThixColors.primary, ThixColors.gold])), child: CircleAvatar(radius: 23, backgroundColor: ThixColors.softBlue, backgroundImage: avatarUrl != null && avatarUrl!.isNotEmpty ? NetworkImage(avatarUrl!) : null))
