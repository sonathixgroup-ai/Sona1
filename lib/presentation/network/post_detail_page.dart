...
class PostDetailPage extends StatefulWidget {
  final String postId;
  final String currentProfileId; // Ajout pour transmettre au PostCard
...
class _PostDetailPageState extends State<PostDetailPage> {
  ...
  Future<void> _editPost() async {
    // déjà géré dans PostCard via onEdit, mais peut être surchargé
          ...
          children: [
            ListTile(
              ...
              trailing: PopupMenuButton(
                ...
                onSelected: (value) {
                  if (value == 'delete') {
                    // Implémenter la suppression si besoin (déjà dans le menu)
                  }
                },
                itemBuilder: (context) => [
                  if (isOwn)
