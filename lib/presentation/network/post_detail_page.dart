...
class _PostDetailPageState extends State<PostDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Détail de la publication', style: TextStyle(color: Colors.black)),
      ...
      body: _isLoading
          ...
          : _post == null
              ? Center(
                  child: Text('Publication introuvable', style: TextStyle(color: Colors.grey)),
                )
              : Column(
                  children: [
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        child: CustomScrollView(
                          ...
                          slivers: [
                            // Post en haut, défilant avec le reste
                            SliverToBoxAdapter(
                              child: Padding(
                            ...
                            // Espacement en bas pour éviter que la barre de saisie cache le dernier élément
              ...
              trailing: PopupMenuButton(
                ...
                onSelected: (value) {
                  if (value == 'delete') {
                    ...
                    // Implémentez la logique de signalement
                  }
                },
                itemBuilder: (context) => [
                  if (isOwn)
  ...
  Future<void> _deleteComment(Comment comment) async {
    ...
    if (confirm == true) {
      try {
        await context.read<NetworkService>().deleteComment(comment.id);
        setState(() {
