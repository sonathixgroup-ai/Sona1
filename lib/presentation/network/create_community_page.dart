...
class _CreateCommunityPageState extends State<CreateCommunityPage> {
  ...
  void initState() {
    super.initState();
    // OPTIMISATION 1 : Récupération de l'instance unique via le Provider
    ...
    try {
      ...
      if (_selectedLogoBytes != null) {
        ...
        bannerUrl = await _networkService.uploadImageBytes(
          ...
          bucket: 'community_logos', // Assure-toi que ce bucket existe et est configuré dans Supabase !
        );
        setState(() => _isUploading = false);
      }

      await _networkService.createCommunity(
        name: name,
  ...
  Widget build(BuildContext context) {
    // OPTIMISATION 2 : PopScope bloque la touche retour d'Android et le swipe d'iOS pendant l'upload
    return PopScope(
      canPop: !_isCreating,
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop && _isCreating) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Création en cours, veuillez patienter...')),
          );
        }
      },
      child: Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Stack(
                  children: [
                      ...
                      child: IgnorePointer(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: _isCreating ? Colors.grey : const Color(0xFFD4AF37),
                              shape: BoxShape.circle,
                            ),
                            child: _isUploading
                                ? const SizedBox(
                    ...
                    if (_selectedLogoBytes != null && !_isUploading && !_isCreating)
                      Positioned(
                        bottom: 0,
                        left: 0,
                        child: GestureDetector(
              ...
              TextField(
                ...
                enabled: !_isCreating,
                decoration: const InputDecoration(
                  hintText: 'Décrivez l\'objectif de votre communauté...',
                  border: OutlineInputBorder(),
