...
class _MarketHomePageState extends State<MarketHomePage> {
      ...
      try { 
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Erreur : La route "$routeName" est introuvable.'), 
  ...
  void _goToUserDashboard() {
    try { 
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Dashboard non configuré dans les routes.'), 
  ...
  Widget _networkImage(String? url, {BoxFit fit = BoxFit.cover}) {
    ...
    return CachedNetworkImage(
      ...
      placeholder: (_, __) => Container(
        color: _MarketColors.lightBg, 
        child: const Center(
          child: CircularProgressIndicator(strokeWidth: 2, color: _MarketColors.red)
        )
      ), 
  ...
  void _showComingSoon(String feature) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: _MarketColors.gold, 
            ...
            if (allProducts.isNotEmpty) 
              ...
              const SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Center(
                    child: Text('Aucun produit disponible pour le moment', style: TextStyle(color: _MarketColors.mutedText, fontSize: 13))
                  )
                )
              ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const Text('Achetez. Vendez. Évoluez.', style: TextStyle(color: _MarketColors.mutedText, fontSize: 11.5, fontWeight: FontWeight.w500))
                ]
              )
            ]
          ), 
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [_MarketColors.redDark, _MarketColors.red]), 
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          ...
                          child: Opacity(
                            opacity: 0.18, 
                            child: const Icon(Icons.shopping_cart_rounded, size: 140, color: Colors.white)
                          )
                        ), 
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start, 
                          ...
                          children: [
                            if (isFirst) 
                              Text('Bonjour, ${_greetingName(marketProvider)} 👋', style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w600)), 
  ...
  Widget _buildTrustBadges() { 
    ...
    return Container(
      ...
      child: Row(
        ...
        children: badges.map((b) => Flexible(
          child: Row(
            mainAxisSize: MainAxisSize.min, 
            children: [
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: WishlistButton(productId: product['id'].toString(), size: 20, activeColor: _MarketColors.red, inactiveColor: _MarketColors.mutedText)
                    )
                  )
                ] 
              )
                  ...
                  children: [
                    ...
                    if (product['rating'] != null) Row(
                      children: [
                        ...
                        if (product['reviews_count'] != null) Text(' (${product['reviews_count']})', style: const TextStyle(fontSize: 9, color: _MarketColors.mutedText))
                      ]
                    ), 
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            ...
                            maxLines: 1, 
                            overflow: TextOverflow.ellipsis, 
                            style: const TextStyle(fontSize: 9.5, color: _MarketColors.mutedText, fontWeight: FontWeight.w600)
                          )
                        )
                      ]
                    ), 
