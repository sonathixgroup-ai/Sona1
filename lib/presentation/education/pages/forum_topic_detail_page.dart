...
class _ForumTopicDetailPageState extends State<ForumTopicDetailPage> {
  ...
  Future<void> _sendReply() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Réponse envoyée !'), backgroundColor: Color(0xFF2ECC71)),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Sujet du forum', style: TextStyle(fontWeight: FontWeight.w800, color: Color(0xFF1A1A2E))),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border(top: BorderSide(color: const Color(0xFFE7EEFC))),
                  ),
                  child: Row(
                    children: [
                      Expanded(
          ...
          if (reply.isSolution)
            Padding(
              ...
              child: Container(
                ...
                child: const Text(
                  '✅ Solution',
                  style: TextStyle(fontSize: 11, fontWeight: FontWeight.W700, color: Color(0xFF2ECC71)),
                ),
              ),
            ),
        ],
