        ...
        title: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0A3D62)),
            ),
            Text(
              '${provider.departureDate.day}/${provider.departureDate.month} • ${provider.passengers} passager(s) • ${provider.filteredResults.length} trajets',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        ElevatedButton(onPressed: () => provider.search(), child: const Text('Réessayer')),
                      ],
                    ),
                  ),
                );
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text('Aucun trajet trouvé', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const SizedBox(height: 6),
                      Text('Essayez une autre date ou destination', style: TextStyle(color: Colors.grey.shade600)),
                      const SizedBox(height: 16),
                      OutlinedButton(onPressed: () => provider.clearFilters(), child: const Text('Effacer les filtres')),
                    ],
                  ),
                );
              }
...
class _SortChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChoiceChip(
      label: Text(
        label,
        style: TextStyle(fontSize: 12, color: selected? Colors.white : Colors.black87, fontWeight: selected? FontWeight.bold : FontWeight.normal),
      ),
      selected: selected,
