...
import '../widgets/service_grid.dart'; // Ajout de l'import de ton fichier externe
...
class _DashboardPageState extends ConsumerState<DashboardPage> {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          // Section Solde (Balance Card externe)
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                _top4UnifiedCard(), // Nouvelle carte unifiée pour les actions rapides
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: surfaceWhite,
                    border: Border.all(color: premiumGold.withOpacity(0.5), width: 1.5), // Touche d'or
                    boxShadow: [
  ...
  Widget _promoCardPremium() => Container(
    ...
    decoration: BoxDecoration(
      ...
      image: DecorationImage(
        image: const AssetImage('assets/noise_texture.png'), // Mettez une texture subtile si disponible
        fit: BoxFit.cover,
  ...
  // ==========================================
  // LISTE DES TRANSACTIONS : UNIFIÉE DANS UNE CARTE
  // ==========================================
  Widget _transactionsList() => FutureBuilder<String>(
    ...
    builder: (c,s){ 
      ...
      return FutureBuilder(
        future: Supabase.instance.client.from('thix_transactions').select().eq('thix_id', s.data!).order('created_at', ascending:false).limit(4), 
        builder: (c,snap){ 
