// 📁 lib/presentation/thix_sante/pharmacy/screens/pharmacy_messages_screen.dart

import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import '../../../common/widgets/empty_state.dart';

class PharmacyMessagesScreen extends ConsumerStatefulWidget {
  const PharmacyMessagesScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<PharmacyMessagesScreen> createState() => _PharmacyMessagesScreenState();
}

class _PharmacyMessagesScreenState extends ConsumerState<PharmacyMessagesScreen> {
  final List<Map<String, dynamic>> _conversations = [
    {'name': 'Dr. Martin', 'lastMessage': 'Ordonnance envoyée', 'time': '14h30', 'unread': 1},
    {'name': 'Michel Dupont', 'lastMessage': 'Merci pour la livraison', 'time': 'Hier', 'unread': 0},
    {'name': 'Sophie Martin', 'lastMessage': 'Quand sera-t-elle prête ?', 'time': 'Hier', 'unread': 0},
  ];
    ...
    return Scaffold(
      ...
      body: _conversations.isEmpty
          ? const EmptyStateWidget(
              title: 'Aucun message',
              subtitle: 'Vos conversations avec les patients et médecins',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) => Align(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        i.isEven ? 'Merci' : 'Bonjour, avez-vous reçu l\'ordonnance ?',
