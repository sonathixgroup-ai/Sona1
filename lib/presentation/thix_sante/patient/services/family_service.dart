// lib/presentation/thix_sante/patient/services/famille_service.dart
import 'dart:io';
...
class FamilleService {
  ...
  Future<Map<String,dynamic>> addMember({required String thixId, required String nom, String? postnom, required String prenom, required DateTime dob, required String sexe, required String lien, String groupe='O+', double? poids, double? taille, String? avatarUrl}) async {
    final uid = _db.auth.currentUser!.id;
    final payload = {
      'tuteur_id': uid,
      ...
      'avatar_url': avatarUrl, 'is_verified': true,
    };
