              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: const LinearGradient(
                    colors: [_C.emerald, Color(0xFF059669)]
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: _C.emerald.withOpacity(0.25),
                      blurRadius: 12,
                  ...
                  child: (avatarUrl != null && avatarUrl.isNotEmpty)
                      ? Image.network(
                          ...
                          errorBuilder: (_, __, ___) => Container(
                            color: _C.white,
                            child: const Icon(Icons.person_rounded, color: _C.navy, size: 22)
                          )
                        )
                      : Container(
                          color: _C.white,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Bonjour $name',
                  style: const TextStyle(fontSize: 17.5, fontWeight: FontWeight.w900, color: _C.navy, letterSpacing: -0.4),
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: _C.red.withOpacity(0.12), blurRadius: 10)]
              ),
              child: const Row(
    ...
    return Padding(
      ...
      child: statsAsync.when(
        loading: () => Container(
          ...
          child: const Center(child: CircularProgressIndicator(strokeWidth: 2, color: _C.sky))
        ),
    ...
    return Expanded(
      child: Row(
        children: [
          ...
          if (showDivider)
            Container(height: 36, width: 1, color: _C.border),
        ]
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          color: _C.white,
          border: Border.all(color: const Color(0x3328B3F0)),
          boxShadow: const [BoxShadow(color: Color(0x12000000), blurRadius: 28, offset: Offset(0, 12))]
        ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const LinearGradient(colors: [_C.sky, _C.teal], begin: Alignment.topLeft, end: Alignment.bottomRight),
                    boxShadow: [BoxShadow(color: _C.sky.withOpacity(0.3), blurRadius: 12)]
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 6,
                        height: 6,
                        decoration: const BoxDecoration(color: _C.emerald, shape: BoxShape.circle, boxShadow: [BoxShadow(color: _C.emerald, blurRadius: 6)])
                      ),
                      const SizedBox(width: 6),
                      const Text('Live', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF047857)))
                    ]
                  )
                ),
              ]
              ...
              child: Container(
                ...
                child: const Row(
                  children: [
                    ...
                    SizedBox(width: 12),
                    Expanded(
                      child: Text('Discuter avec l\'IA... Poser une question santé', style: TextStyle(fontSize: 13, color: _C.textFaint, fontWeight: FontWeight.w500))
                    ),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(24),
                  gradient: const LinearGradient(
                    colors: [_C.sky, _C.skyDark],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight
                  ),
                  boxShadow: [
                    BoxShadow(color: _C.sky.withOpacity(0.32), blurRadius: 22, offset: const Offset(0, 12))
                  ]
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('3 en ligne', style: TextStyle(color: Colors.white.withOpacity(0.9), fontSize: 10, fontWeight: FontWeight.w700))
                            ]
                          )
                        ),
                      ]
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text('Consulter maintenant', style: TextStyle(color: _C.navy, fontSize: 12.5, fontWeight: FontWeight.w900))
                        ),
                      ]
                    ),
                  ]
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      color: _C.navy,
                      boxShadow: [BoxShadow(color: _C.navy.withOpacity(0.28), blurRadius: 18, offset: const Offset(0, 8))]
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('RENDEZ-VOUS', style: TextStyle(fontSize: 9, fontWeight: FontWeight.w800, color: Colors.white.withOpacity(0.55), letterSpacing: 0.7)),
                            Container(
                              height: 24,
                              width: 24,
                              decoration: BoxDecoration(color: Colors.white.withOpacity(0.12), shape: BoxShape.circle),
                              child: const Icon(Icons.calendar_month_rounded, size: 13, color: Colors.white)
                            )
                          ]
                        ),
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.warning_amber_rounded, size: 14, color: _C.red)
                            ),
                            const SizedBox(width: 6),
                            const Text('URGENCE', style: TextStyle(fontSize: 9.5, fontWeight: FontWeight.w900, color: _C.red, letterSpacing: 0.6))
                          ]
                        ),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(rdvs > 0 ? '$rdvs RDV' : 'Aucun', style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: _C.textFaint))
                ),
              ]
            ),
            const SizedBox(height: 14),
                  ...
                  child: Row(
                    children: [
                      Container(
                        height: 36,
                        width: 36,
                        decoration: BoxDecoration(color: _C.sky.withOpacity(0.15), shape: BoxShape.circle),
                        child: const Icon(Icons.event_available_rounded, size: 18, color: _C.sky)
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(rdvs == 1 ? '1 rendez-vous à venir' : '$rdvs rendez-vous à venir', style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700, color: _C.navy))
                      ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        height: 36,
                        width: 36,
                        decoration: BoxDecoration(color: _C.textFaint.withOpacity(0.08), shape: BoxShape.circle),
                        child: const Icon(Icons.event_note_rounded, size: 18, color: _C.textFaint)
                      ),
                      const SizedBox(width: 12),
                      const Expanded(
                        child: Text('Aucun rendez-vous prévu', style: TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700, color: _C.textMuted))
                      ),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                        decoration: BoxDecoration(color: _C.navy, borderRadius: BorderRadius.circular(20)),
                        child: const Text('Planifier', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: Colors.white))
                      ),
                    ]
                  ),
                ),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: it.color.withOpacity(0.12), blurRadius: 8)]
                    ),
              ...
              child: Row(
                children: [
                  Container(
                    height: 56,
                    width: 56,
                    decoration: BoxDecoration(color: const Color(0xFFEEF4FF), borderRadius: BorderRadius.circular(14), border: Border.all(color: const Color(0xFFDBEAFE))),
                    child: const Icon(Icons.local_pharmacy_rounded, color: _C.emerald, size: 26)
                  ),
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.circle, size: 8, color: _C.emerald),
                            SizedBox(width: 4),
                            Text('Ouvertes maintenant • Livraison 20min', style: TextStyle(fontSize: 11, color: _C.textFaint, fontWeight: FontWeight.w600))
                          ]
                        ),
                      ]
                    )
                  ...
                  Container(
                    height: 28,
                    width: 28,
                    decoration: BoxDecoration(color: _C.bg, shape: BoxShape.circle, border: Border.all(color: _C.border)),
                    child: const Icon(Icons.chevron_right_rounded, color: _C.navy, size: 18)
                  ),
                ]
              ),
            ),
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _C.navy,
                borderRadius: BorderRadius.circular(20),
                boxShadow: [BoxShadow(color: _C.navy.withOpacity(0.22), blurRadius: 18, offset: const Offset(0, 8))]
              ),
              child: Row(
                children: [
                  Container(
  ...
  Widget _bottomNav() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: _C.white.withOpacity(0.96),
          borderRadius: BorderRadius.circular(28),
          border: Border.all(color: _C.borderStrong),
          boxShadow: const [BoxShadow(color: Color(0x1A000000), blurRadius: 28, offset: Offset(0, 12))]
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            gradient: const LinearGradient(colors: [_C.sky, _C.teal], begin: Alignment.topLeft, end: Alignment.bottomRight),
            boxShadow: [BoxShadow(color: _C.sky.withOpacity(0.38), blurRadius: 18, offset: const Offset(0, 7))],
            border: Border.all(color: Colors.white, width: 2)
          ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: active ? _C.navy.withOpacity(0.08) : Colors.transparent,
