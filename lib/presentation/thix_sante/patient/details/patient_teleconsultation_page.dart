  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (widget.consultationId != null) {
        ...
        final typeName =
            consultationData['type'] as String? ??
                AppointmentType.teleconsultation.name;

        final statusName =
            consultationData['status'] as String? ??
        ...
        _consultation = Appointment(
          ...
          doctorName:
              consultationData['doctor_name'] as String? ?? 'Médecin',
          doctorSpecialty:
              consultationData['doctor_specialty'] as String?,
          patientId:
              consultationData['patient_id'] as String? ?? user.id,
          patientName:
              consultationData['patient_name'] as String? ?? '',
          date: DateTime.parse(
            consultationData['scheduled_at'] as String,
          ),
          ...
          teleconsultationLink:
              consultationData['teleconsultation_link'] as String?,
          isEmergency:
              consultationData['is_emergency'] as bool? ?? false,
        );
        ...
        _selectedTime = TimeOfDay(
          hour: _consultation!.date.hour,
          minute: _consultation!.date.minute,
        );
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final payload = {
        ...
        'doctor_specialty':
            _doctorSpecialtyController.text.trim().isNotEmpty
        ...
        if (c.teleconsultationLink != null)
          Card(
            ...
            child: ListTile(
              ...
              subtitle:
                  Text(c.teleconsultationLink!),
              trailing: ElevatedButton(
                onPressed: () {
                  context.push(
                    '/sante/patient/teleconsultation/jitsi',
                    extra:
                        c.teleconsultationLink!,
                  );
                },
                child: const Text(
                  'Rejoindre',
