...
class PatientVitalPage extends StatefulWidget {
  ...
  @override
  State<PatientVitalPage> createState() =>
      _PatientVitalPageState();
}

class _PatientVitalPageState
    extends State<PatientVitalPage> {
