...
class _ServicesConstellationState extends State<_ServicesConstellation> with TickerProviderStateMixin {
  ...
  List<_ServiceNodeData> _nodes(AppLocalizations l10n) {
    ...
    return [
      _ServiceNodeData(key: 'thixMedia', icon: Icons.play_circle_filled, title: l10n.t('serviceMedia'), color: AppColors.domainMedia),
      ...
      _ServiceNodeData(key: 'thixInfo', icon: Icons.newspaper_rounded, title: l10n.t('serviceInfo'), color: AppColors.domainInfo, badge: c.info),
